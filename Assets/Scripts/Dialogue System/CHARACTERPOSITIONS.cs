...
public class CHARACTERPOSITIONS : MonoBehaviour
{
    ...
    public static Vector2 centerLeft = new Vector2(0f, 0.575f);
    public static Vector2 centerRight = new Vector2(1f, 0.575f);

    public static List<Vector2> characterPositionsList = new List<Vector2>() // Make sure we copy the order in LocationEnum
    { stay, bottomLeft, bottomRight, center, topLeft, topRight, centerLeft, centerRight, topCenter };
